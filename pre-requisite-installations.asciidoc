...
----
// JWASHBURN: Seems like these single quotes are being lost in the rendered html, website output
//            is missing the quotes and appears to be making the text italic instead
